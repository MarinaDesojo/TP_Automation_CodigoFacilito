...
class GroceriesPage(BasePage):
    # URL
    URL = "https://shophub-commerce.vercel.app/categories/groceries"  # mejor practica en un archivo de datos modularizado
    # Header
    ...
    def go_to_product_page_by_number(self, product_number: str):
        ...
        if not product_number.isdigit() or not (41 <= int(product_number) <= 50):
            raise ValueError("product_number debe estar entre '41' y '50'")
