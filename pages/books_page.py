...
class BooksPage(BasePage):
    # URL
    URL = "https://shophub-commerce.vercel.app/categories/books"  # mejor practica en un archivo de datos modularizado
    # Header
    ...
    def go_to_product_page_by_number(self, product_number: str):
        ...
        if not product_number.isdigit() or not (31 <= int(product_number) <= 40):
            raise ValueError("product_number debe estar entre '31' y '40'")
