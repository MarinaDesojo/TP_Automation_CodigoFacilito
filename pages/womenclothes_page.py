...
class WomenClothesPage(BasePage):
    # URL
    URL = "https://shophub-commerce.vercel.app/categories/women-clothes"  # mejor practica en un archivo de datos modularizado
    # Header
    ...
    def go_to_product_page_by_number(self, product_number: str):
        ...
        if not product_number.isdigit() or not (11 <= int(product_number) <= 20):
            raise ValueError("product_number debe estar entre '11' y '20'")
