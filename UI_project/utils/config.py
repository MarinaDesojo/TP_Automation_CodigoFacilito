...
PASSWORD_MAX_CHAR = os.getenv("TEST_PASSWORD_MAX_CHAR")
PASSWORD_MAX_CHAR_PLUS1 = os.getenv("TEST_PASSWORD_MAX_CHAR_PLUS1")
...
EMAIL_MAX_CHAR = os.getenv("TEST_EMAIL_MAX_CHAR")
EMAIL_MAX_CHAR_PLUS1 = os.getenv("TEST_EMAIL_MAX_CHAR_PLUS1")
